...
const Form = props => {
    ...
    let suggestion =
        ...
        {
            if (inputValue!==''){
                if (city.toUpperCase().indexOf(inputValue.toUpperCase()) > -1 ){
                    return <li onClick={()=>{
                        setInputValue(city)
                        setSuggest(true)
                    }} className={suggest?'liNone':'li'}>{city}</li>
                }
            }
            ...
            <form onSubmit={props.loadweather}>
                ...
                <div className="row">
                    <div className="col-md-6 offset-md-2">
                        ...
                        />
                        <ul style={{color:'white', listStyle:'none',maxHeight:'170px',overflow:'hidden'}}>
                            {suggestion}
                        </ul>
